...
type StreamServiceClient interface {
	...
	List(ctx context.Context, in *StreamInfoRequest, opts ...grpc.CallOption) (StreamService_ListClient, error)
...
func (c *streamServiceClient) List(ctx context.Context, in *StreamInfoRequest, opts ...grpc.CallOption) (StreamService_ListClient, error) {
...
func (x *streamServiceListClient) Recv() (*StreamInfoResponse, error) {
	m := new(StreamInfoResponse)
...
type StreamService_RecordClient interface {
	Send(*StreamInfoRequest) error
	CloseAndRecv() (*StreamInfoResponse, error)
	grpc.ClientStream
}
...
func (x *streamServiceRecordClient) Send(m *StreamInfoRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceRecordClient) CloseAndRecv() (*StreamInfoResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(StreamInfoResponse)
...
func (x *streamServiceRouteClient) Send(m *StreamInfoRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceRouteClient) Recv() (*StreamInfoResponse, error) {
	m := new(StreamInfoResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type StreamServiceServer interface {
	// server-side stream RPC
	List(*StreamInfoRequest, StreamService_ListServer) error
	// client-side stream RPC
...
func (UnimplementedStreamServiceServer) List(*StreamInfoRequest, StreamService_ListServer) error {
...
func (x *streamServiceListServer) Send(m *StreamInfoResponse) error {
...
type StreamService_RecordServer interface {
	SendAndClose(*StreamInfoResponse) error
	Recv() (*StreamInfoRequest, error)
	grpc.ServerStream
}
...
func (x *streamServiceRecordServer) SendAndClose(m *StreamInfoResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceRecordServer) Recv() (*StreamInfoRequest, error) {
	m := new(StreamInfoRequest)
...
func (x *streamServiceRouteServer) Send(m *StreamInfoResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceRouteServer) Recv() (*StreamInfoRequest, error) {
	m := new(StreamInfoRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "libs/rpc/proto/stream.proto",
}
